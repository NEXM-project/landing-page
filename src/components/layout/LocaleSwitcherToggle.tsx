...
export const LocaleSwitcherToggle = () => {
  ...
  return (
    <button
      ...
      className="fixed hidden lg:inline-flex lg:top-28 xl:top-6 right-8 z-40 group items-center justify-center w-19 h-fit rounded-md overflow-hidden bg-linear-to-b from-primary to-violet-900 border border-primary text-white shadow-md hover:shadow-lg cursor-pointer transition-all duration-300 p-2"
